"""
Training script for audio-only baseline model.
Trains only on audio waveforms for emotion classification.
"""
...
class AudioOnlyModel(nn.Module):
    ...
    def __init__(self, num_emotions=8, freeze_backbone=True):
        ...
        print("Audio-Only Model initialized!\n")
...
class Trainer:
    ...
    def save_history(self):
        ...
        history_path = self.log_dir / "training_history_audio_only.json"
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Train audio-only emotion model")
    parser.add_argument("--data_dir", type=str, default="./data/processed",
                       help="Directory with processed metadata")
    parser.add_argument("--checkpoint_dir", type=str, default="./checkpoints/audio_only",
    ...
    # Create model
    print("\nCreating model...")
    model = AudioOnlyModel(num_emotions=8, freeze_backbone=True)
